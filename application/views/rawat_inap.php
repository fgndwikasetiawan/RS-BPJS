      ...
      <div class="col-md-12">
         <div class="panel panel-default">
            ...
            <?php if (isset($pasien->NO_MEDREC)) { ?>
             <form class="form-horizontal" id="form" role="form"  method="post" action="<?php echo base_url();?>rawat_inap/submit">
                         ...
                         <table class="table center-table">
                            ...
                            <tbody>
                               <tr>
                                 ...
                                 <input type="hidden" name="nama" value="<?php if (isset($pasien->NAMA)) echo $pasien->NAMA; ?>">
                               </tr>
                            </tbody>
                            <tbody>
                               <tr>
                     ...
                     <div class="col-md-4">
                       ...
                       <div class="form-group">
                         <label class="control-label col-md-4">Tanggal Daftar <span id="usia">&nbsp;</span></label>
                           <div class="col-md-8">
                             <input type="text" class="form-control datetimepicker" name="tgldaftarri" value="<?php if (isset($pasien->TGLDAFTARRI)) echo $pasien->TGLDAFTARRI; ?>">                        
                           </div>                                             
                       </div>
                       <div class="form-group">      
                       ...
                       <div class="form-group">                      
                         ...
                         <div class="col-md-8">
                           <select class="form-control" name="caramasuk" id="caramasuk">
                       ...
                       <div class="form-group">
                         ...
                         <div class="col-md-4">
                           <select class="form-control" name="kartuidpjawab">
                             <?php foreach($kartuidpjawab as $k) { ?>
                                <option <?php if (isset($pasien->KARTUIDPJAWAB) && $pasien->KARTUIDPJAWAB == $k) echo "selected"; ?>><?php echo $k; ?></option>
                             <?php } ?>
                           </select>
                         </div>
                       ...
                       <div class="form-group">
                         ...
                         <div class="col-md-8">
                           <select class="form-control" name="hubpjawabri" id="hubpjawabri">
                             <?php foreach($hubpjawabri as $h) { ?>
                                <option <?php if (isset($pasien->HUBPJAWABRI) && $pasien->HUBPJAWABRI == $h) echo "selected"; ?>><?php echo $h; ?></option>
                             <?php } ?>
                           </select>
                         </div>
                       </div>                     
